...
//vagy WHERE p.born IN [1964, 1965]
...
WITH p.name AS Nev, COUNT(m.title) AS db  //el kell nevezni, altgr 7 aposztróf közé, de a nélkül is működik
WHERE db>1  //having funkciót tölt be
RETURN Nev, db
```
...
innentől már nem kell a zh-hoz!
