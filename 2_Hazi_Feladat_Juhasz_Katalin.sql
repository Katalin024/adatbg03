 DROP TABLE MaszkoltUgyfel;

CREATE TABLE MaszkoltUgyfel
...
CREATE USER KorlatoltFelhasznalo WITHOUT Login;

GRANT SELECT ON MaszkoltUgyfel TO KorlatoltFelhasznalo;

EXECUTE AS User= 'KorlatoltFelhasznalo';

SELECT * FROM MaszkoltUgyfel;
